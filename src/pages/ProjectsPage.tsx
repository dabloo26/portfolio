...
export function ProjectsPage() {
  ...
  return (
    <main className="relative pt-[7.5rem]">
      ...
      <div className="relative z-10 border-b border-white/[0.06] bg-base px-4 py-10 sm:px-6">
      ...
      <section className="relative z-10 bg-base px-4 py-14 sm:px-6">
      ...
      <section className="relative z-10 border-t border-white/[0.06] bg-base px-4 py-14 sm:px-6">
        <div className="relative z-10 mx-auto max-w-6xl">
